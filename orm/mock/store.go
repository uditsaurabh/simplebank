...
// Source: github.com/uditsaurabh/go-simple-bank/orm (interfaces: Store)
...
import (
	...
	orm "github.com/uditsaurabh/go-simple-bank/orm"
)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 orm.AddAccountBalanceParams) (orm.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAccountBalance", arg0, arg1)
	ret0, _ := ret[0].(orm.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateAccount(arg0 context.Context, arg1 orm.CreateAccountParams) (orm.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(arg0 context.Context, arg1 orm.CreateEntryParams) (orm.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEntry", arg0, arg1)
	ret0, _ := ret[0].(orm.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 orm.CreateTransferParams) (orm.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransfer", arg0, arg1)
	ret0, _ := ret[0].(orm.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateUser(arg0 context.Context, arg1 orm.CreateUserParams) (orm.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccount(arg0 context.Context, arg1 int64) (orm.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int64) (orm.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (orm.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (orm.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUser(arg0 context.Context, arg1 string) (orm.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccounts(arg0 context.Context, arg1 orm.ListAccountsParams) ([]orm.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 orm.ListEntriesParams) ([]orm.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 orm.ListTransfersParams) ([]orm.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 orm.TransferTxParams) (orm.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(orm.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 orm.UpdateAccountParams) (orm.Account, error) {
	m.ctrl.T.Helper()
